...
//                      outputStream.writeObject(response);
                      ...
                      db.addTicket(ticket);
                      response = new PackageData("TICKET ADDED","SERVER",null,null,null,null,null,null,null,ticket, null, null);
                      ...
                      ArrayList<String> flightsName=db.getFlightName();
...
//
                      ...
                      response = new PackageData("TICKET EDITED","SERVER",null,null,null,null,null,null,null,null, null, null);
